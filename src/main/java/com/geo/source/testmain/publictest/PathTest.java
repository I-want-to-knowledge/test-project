...
public class PathTest {
	...
	private void showURL() {
		// 第一种：获取类加载的根路径 
		// D:\Users\Administrator\workspace\my-spring-project\target\classes
		File f = new File(this.getClass().getResource("/").getPath());
		System.out.println(f);

		// 获取当前类的所在工程路径; 如果不加“/” 获取当前类的加载目录 
		// D:\Users\Administrator\workspace\my-spring-project\target\classes\com\geo\source\testmain\publictest
		File f2 = new File(this.getClass().getResource("").getPath());
		System.out.println(f2);

		// 第二种：获取项目路径 
		// D:\Users\Administrator\workspace\my-spring-project
		...
		// 第三种： file:/D:/Users/Administrator/workspace/my-spring-project/target/classes/
		URL xmlpath = this.getClass().getClassLoader().getResource("");
		System.out.println(xmlpath);

		// 第四种： D:\Users\Administrator\workspace\my-spring-project
